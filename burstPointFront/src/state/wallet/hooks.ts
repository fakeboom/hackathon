import { DefaultChainId, SUSHI } from './../../constants/index'
import { Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount } from '@liuxingfeiyu/zoo-sdk'
  ...
  return useMemo(
    () =>
      currencies?.map(currency => {
        ...
        if (currency === nativeToken) return ethBalance[account]
        return undefined
      }) ?? [],
